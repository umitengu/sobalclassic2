...
namespace Mocopi.Ui
{
	...
	/// スタートメニューへ戻るのダイアログ
	/// </summary>
	public class ReturnToEntrySceneDialog : DialogBase
	{
		/// <summary>
		/// 説明
		/// </summary>
		...
		/// ダイアログ名
		/// </summary>
		public override EnumDialog DialogName { get; } = EnumDialog.ReturnToEntryScene;
		...
		protected override void Awake()
		{
			base.Awake();
			// テキスト設定
			this.Description.text = TextManager.stop_capture_dialog_description;
			this.ButtonExecution.Text.text = TextManager.return_to_entry_scene_dialog_stop;
