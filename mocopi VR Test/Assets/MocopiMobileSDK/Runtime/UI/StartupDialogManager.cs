...
namespace Mocopi.Ui.Startup
{
	...
	/// ダイアログの管理クラス
	/// </summary>
	public sealed class StartupDialogManager : DialogManagerBase
	{
		/// <summary>
		/// ダイアログの親オブジェクト
		/// </summary>
		...
		/// </summary>
		[SerializeField]
		private PairingErrorDialog _pairingError;
		...
		/// </summary>
		[SerializeField]
		private Dialog _pcTransferDialog;

		/// <summary>
		/// HWボタンチュートリアルダイアログ
		/// </summary>
		[SerializeField]
		private Dialog _hwButtonTutorialDialog;
		...
		/// </summary>
		/// <returns></returns>
		public override PairingErrorDialog CreatePairingErrorDialog()
		{
			return base.Create<PairingErrorDialog>(this._pairingError, this._dialogParent);
		}
		...
		{
			return base.Create<ToggleDialog>(this._toggleDialog, this._dialogParent);
		}
